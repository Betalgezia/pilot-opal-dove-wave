...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-11 w-full min-w-0 items-center gap-1 overflow-x-auto rounded-lg bg-surface p-1 shadow-border",
      className,
    )}
    {...props}
  />
